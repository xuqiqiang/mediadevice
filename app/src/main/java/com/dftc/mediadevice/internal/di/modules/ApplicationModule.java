...
import com.dftc.mediadevice.UIThread;
import com.dftc.mediadevice.data.executor.JobExecutor;
import com.dftc.mediadevice.data.repository.CameraDataRepository;
...
public class ApplicationModule {
    ...
    @Provides
    @Singleton
    CameraRepository provideCameraRepository(CameraDataRepository cameraDataRepository) {
        return cameraDataRepository;
    }
}

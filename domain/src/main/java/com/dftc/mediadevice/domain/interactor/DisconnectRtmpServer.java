 ...
 */
public class DisconnectRtmpServer extends UseCase<Boolean, DisconnectRtmpServer.Params> {

    private final CameraRepository userRepository;

    @Inject
    DisconnectRtmpServer(CameraRepository userRepository, ThreadExecutor threadExecutor,
    ...
    Observable<Boolean> buildUseCaseObservable(Params params) {
        ...
        return this.userRepository.rtmpServer(params.serId);
    }
    ...
    public static final class Params {
        ...
        private Params(Integer serId) {
            this.serId = serId;
        }

        public static Params forUser(Integer serId) {
            return new Params(serId);
        }
    }
}

 ...
 */
public class AnnexH264 extends UseCase<Boolean, AnnexH264.Params> {

    private final CameraRepository userRepository;

    @Inject
    AnnexH264(CameraRepository userRepository, ThreadExecutor threadExecutor,
    ...
    Observable<Boolean> buildUseCaseObservable(Params params) {
        ...
        return this.userRepository.annexH264(params.cameraDevice, params.serId);
    }

...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.8 2013-11-22 13:02:47 GMT")
...
{	struct __ns10__Notify soap_tmp___ns10__Notify;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationConsumer/Notify";
	soap->encodingStyle = NULL;
	soap_tmp___ns10__Notify.wsnt__Notify = wsnt__Notify;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns10__Notify(soap, &soap_tmp___ns10__Notify);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns10__Notify(soap, &soap_tmp___ns10__Notify, "-ns10:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___ns10__Notify(soap, _param_7);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___ns10__Notify(soap, _param_7, "-ns10:Notify", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __ns11__GetMessages soap_tmp___ns11__GetMessages;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/GetMessagesRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns11__GetMessages.wsnt__GetMessages = wsnt__GetMessages;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns11__GetMessages(soap, &soap_tmp___ns11__GetMessages);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns11__GetMessages(soap, &soap_tmp___ns11__GetMessages, "-ns11:GetMessages", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns11__DestroyPullPoint soap_tmp___ns11__DestroyPullPoint;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/DestroyPullPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns11__DestroyPullPoint.wsnt__DestroyPullPoint = wsnt__DestroyPullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns11__DestroyPullPoint(soap, &soap_tmp___ns11__DestroyPullPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns11__DestroyPullPoint(soap, &soap_tmp___ns11__DestroyPullPoint, "-ns11:DestroyPullPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns11__Notify soap_tmp___ns11__Notify;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PullPoint/Notify";
	soap->encodingStyle = NULL;
	soap_tmp___ns11__Notify.wsnt__Notify = wsnt__Notify;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns11__Notify(soap, &soap_tmp___ns11__Notify);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns11__Notify(soap, &soap_tmp___ns11__Notify, "-ns11:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{
	soap_default___ns11__Notify(soap, _param_8);
	soap_begin(soap);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get___ns11__Notify(soap, _param_8, "-ns11:Notify", NULL);
	if (soap->error == SOAP_TAG_MISMATCH && soap->level == 2)
		soap->error = SOAP_NO_METHOD;
	if (soap->error
	 || soap_body_end_in(soap)
...
{	struct __ns12__CreatePullPoint soap_tmp___ns12__CreatePullPoint;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/CreatePullPoint/CreatePullPointRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns12__CreatePullPoint.wsnt__CreatePullPoint = wsnt__CreatePullPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns12__CreatePullPoint(soap, &soap_tmp___ns12__CreatePullPoint);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns12__CreatePullPoint(soap, &soap_tmp___ns12__CreatePullPoint, "-ns12:CreatePullPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__Renew soap_tmp___ns13__Renew;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/RenewRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__Renew.wsnt__Renew = wsnt__Renew;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__Renew(soap, &soap_tmp___ns13__Renew);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__Renew(soap, &soap_tmp___ns13__Renew, "-ns13:Renew", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__Unsubscribe soap_tmp___ns13__Unsubscribe;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/UnsubscribeRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__Unsubscribe.wsnt__Unsubscribe = wsnt__Unsubscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__Unsubscribe(soap, &soap_tmp___ns13__Unsubscribe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__Unsubscribe(soap, &soap_tmp___ns13__Unsubscribe, "-ns13:Unsubscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__PauseSubscription soap_tmp___ns13__PauseSubscription;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/PauseSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__PauseSubscription.wsnt__PauseSubscription = wsnt__PauseSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__PauseSubscription(soap, &soap_tmp___ns13__PauseSubscription);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__PauseSubscription(soap, &soap_tmp___ns13__PauseSubscription, "-ns13:PauseSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns13__ResumeSubscription soap_tmp___ns13__ResumeSubscription;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/PausableSubscriptionManager/ResumeSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns13__ResumeSubscription.wsnt__ResumeSubscription = wsnt__ResumeSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns13__ResumeSubscription(soap, &soap_tmp___ns13__ResumeSubscription);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns13__ResumeSubscription(soap, &soap_tmp___ns13__ResumeSubscription, "-ns13:ResumeSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns2__Hello soap_tmp___ns2__Hello;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/network/wsdl/Hello";
	soap->encodingStyle = NULL;
	soap_tmp___ns2__Hello.tdn__Hello = tdn__Hello;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns2__Hello(soap, &soap_tmp___ns2__Hello);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__Hello(soap, &soap_tmp___ns2__Hello, "-ns2:Hello", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns2__Bye soap_tmp___ns2__Bye;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/network/wsdl/Bye";
	soap->encodingStyle = NULL;
	soap_tmp___ns2__Bye.tdn__Bye = tdn__Bye;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns2__Bye(soap, &soap_tmp___ns2__Bye);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__Bye(soap, &soap_tmp___ns2__Bye, "-ns2:Bye", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns3__Probe soap_tmp___ns3__Probe;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/network/wsdl/Probe";
	soap->encodingStyle = NULL;
	soap_tmp___ns3__Probe.tdn__Probe = tdn__Probe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns3__Probe(soap, &soap_tmp___ns3__Probe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns3__Probe(soap, &soap_tmp___ns3__Probe, "-ns3:Probe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns4__GetSupportedRules soap_tmp___ns4__GetSupportedRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetSupportedRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns4__GetSupportedRules.tan__GetSupportedRules = tan__GetSupportedRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns4__GetSupportedRules(soap, &soap_tmp___ns4__GetSupportedRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns4__GetSupportedRules(soap, &soap_tmp___ns4__GetSupportedRules, "-ns4:GetSupportedRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns4__CreateRules soap_tmp___ns4__CreateRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/CreateRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns4__CreateRules.tan__CreateRules = tan__CreateRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns4__CreateRules(soap, &soap_tmp___ns4__CreateRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns4__CreateRules(soap, &soap_tmp___ns4__CreateRules, "-ns4:CreateRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns4__DeleteRules soap_tmp___ns4__DeleteRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/DeleteRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns4__DeleteRules.tan__DeleteRules = tan__DeleteRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns4__DeleteRules(soap, &soap_tmp___ns4__DeleteRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns4__DeleteRules(soap, &soap_tmp___ns4__DeleteRules, "-ns4:DeleteRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns4__GetRules soap_tmp___ns4__GetRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns4__GetRules.tan__GetRules = tan__GetRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns4__GetRules(soap, &soap_tmp___ns4__GetRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns4__GetRules(soap, &soap_tmp___ns4__GetRules, "-ns4:GetRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns4__ModifyRules soap_tmp___ns4__ModifyRules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/ModifyRules";
	soap->encodingStyle = NULL;
	soap_tmp___ns4__ModifyRules.tan__ModifyRules = tan__ModifyRules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns4__ModifyRules(soap, &soap_tmp___ns4__ModifyRules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns4__ModifyRules(soap, &soap_tmp___ns4__ModifyRules, "-ns4:ModifyRules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns5__GetServiceCapabilities soap_tmp___ns5__GetServiceCapabilities;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns5__GetServiceCapabilities.tan__GetServiceCapabilities = tan__GetServiceCapabilities;
	soap_begin(soap);
	soap_serializeheader(soap);
...
{	struct __ns5__GetSupportedAnalyticsModules soap_tmp___ns5__GetSupportedAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetSupportedAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__GetSupportedAnalyticsModules.tan__GetSupportedAnalyticsModules = tan__GetSupportedAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__GetSupportedAnalyticsModules(soap, &soap_tmp___ns5__GetSupportedAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__GetSupportedAnalyticsModules(soap, &soap_tmp___ns5__GetSupportedAnalyticsModules, "-ns5:GetSupportedAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns5__CreateAnalyticsModules soap_tmp___ns5__CreateAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/CreateAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__CreateAnalyticsModules.tan__CreateAnalyticsModules = tan__CreateAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__CreateAnalyticsModules(soap, &soap_tmp___ns5__CreateAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__CreateAnalyticsModules(soap, &soap_tmp___ns5__CreateAnalyticsModules, "-ns5:CreateAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns5__DeleteAnalyticsModules soap_tmp___ns5__DeleteAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/DeleteAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__DeleteAnalyticsModules.tan__DeleteAnalyticsModules = tan__DeleteAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__DeleteAnalyticsModules(soap, &soap_tmp___ns5__DeleteAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__DeleteAnalyticsModules(soap, &soap_tmp___ns5__DeleteAnalyticsModules, "-ns5:DeleteAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns5__GetAnalyticsModules soap_tmp___ns5__GetAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/GetAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__GetAnalyticsModules.tan__GetAnalyticsModules = tan__GetAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__GetAnalyticsModules(soap, &soap_tmp___ns5__GetAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__GetAnalyticsModules(soap, &soap_tmp___ns5__GetAnalyticsModules, "-ns5:GetAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns5__ModifyAnalyticsModules soap_tmp___ns5__ModifyAnalyticsModules;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver20/analytics/wsdl/ModifyAnalyticsModules";
	soap->encodingStyle = NULL;
	soap_tmp___ns5__ModifyAnalyticsModules.tan__ModifyAnalyticsModules = tan__ModifyAnalyticsModules;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns5__ModifyAnalyticsModules(soap, &soap_tmp___ns5__ModifyAnalyticsModules);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns5__ModifyAnalyticsModules(soap, &soap_tmp___ns5__ModifyAnalyticsModules, "-ns5:ModifyAnalyticsModules", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns6__PullMessages soap_tmp___ns6__PullMessages;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/PullMessagesRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns6__PullMessages.tev__PullMessages = tev__PullMessages;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns6__PullMessages(soap, &soap_tmp___ns6__PullMessages);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns6__PullMessages(soap, &soap_tmp___ns6__PullMessages, "-ns6:PullMessages", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns6__Seek soap_tmp___ns6__Seek;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/PullPointSubscription/SeekRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns6__Seek.tev__Seek = tev__Seek;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns6__Seek(soap, &soap_tmp___ns6__Seek);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns6__Seek(soap, &soap_tmp___ns6__Seek, "-ns6:Seek", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns6__SetSynchronizationPoint soap_tmp___ns6__SetSynchronizationPoint;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns6__SetSynchronizationPoint.tev__SetSynchronizationPoint = tev__SetSynchronizationPoint;
	soap_begin(soap);
	soap_serializeheader(soap);
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns6__SetSynchronizationPoint(soap, &soap_tmp___ns6__SetSynchronizationPoint, "-ns6:SetSynchronizationPoint", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns7__GetServiceCapabilities soap_tmp___ns7__GetServiceCapabilities;
	...
	soap->encodingStyle = NULL;
	soap_tmp___ns7__GetServiceCapabilities.tev__GetServiceCapabilities = tev__GetServiceCapabilities;
	soap_begin(soap);
	soap_serializeheader(soap);
...
{	struct __ns7__CreatePullPointSubscription soap_tmp___ns7__CreatePullPointSubscription;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/EventPortType/CreatePullPointSubscriptionRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns7__CreatePullPointSubscription.tev__CreatePullPointSubscription = tev__CreatePullPointSubscription;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns7__CreatePullPointSubscription(soap, &soap_tmp___ns7__CreatePullPointSubscription);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns7__CreatePullPointSubscription(soap, &soap_tmp___ns7__CreatePullPointSubscription, "-ns7:CreatePullPointSubscription", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns7__GetEventProperties soap_tmp___ns7__GetEventProperties;
	if (!soap_action)
		soap_action = "http://www.onvif.org/ver10/events/wsdl/EventPortType/GetEventPropertiesRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns7__GetEventProperties.tev__GetEventProperties = tev__GetEventProperties;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns7__GetEventProperties(soap, &soap_tmp___ns7__GetEventProperties);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns7__GetEventProperties(soap, &soap_tmp___ns7__GetEventProperties, "-ns7:GetEventProperties", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns9__Subscribe soap_tmp___ns9__Subscribe;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/SubscribeRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns9__Subscribe.wsnt__Subscribe = wsnt__Subscribe;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns9__Subscribe(soap, &soap_tmp___ns9__Subscribe);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns9__Subscribe(soap, &soap_tmp___ns9__Subscribe, "-ns9:Subscribe", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}
...
{	struct __ns9__GetCurrentMessage soap_tmp___ns9__GetCurrentMessage;
	if (!soap_action)
		soap_action = "http://docs.oasis-open.org/wsn/bw-2/NotificationProducer/GetCurrentMessageRequest";
	soap->encodingStyle = NULL;
	soap_tmp___ns9__GetCurrentMessage.wsnt__GetCurrentMessage = wsnt__GetCurrentMessage;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns9__GetCurrentMessage(soap, &soap_tmp___ns9__GetCurrentMessage);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns9__GetCurrentMessage(soap, &soap_tmp___ns9__GetCurrentMessage, "-ns9:GetCurrentMessage", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	}

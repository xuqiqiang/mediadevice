...
FCT_BGN()
{
    ...
    FCT_SUITE_BGN(test_suite_cipher)
    {
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_0_bytes)
            size_t length = 0;
            unsigned char key[32];
            unsigned char iv[16];
            ...
            cipher_info = cipher_info_from_type( POLARSSL_CIPHER_BLOWFISH_CBC );
            fct_chk( NULL != cipher_info );
            fct_chk( cipher_info_from_string( "BLOWFISH-CBC" ) == cipher_info );
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_1_byte)
            size_t length = 1;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_2_bytes)
            size_t length = 2;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_7_bytes)
            size_t length = 7;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_8_bytes)
            size_t length = 8;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_9_bytes)
            size_t length = 9;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_15_bytes)
            size_t length = 15;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_16_bytes)
            size_t length = 16;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_17_bytes)
            size_t length = 17;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_31_bytes)
            size_t length = 31;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_32_bytes)
            size_t length = 32;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_47_bytes)
            size_t length = 47;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_48_bytes)
            size_t length = 48;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_49_bytes)
            size_t length = 49;
            unsigned char key[32];
            unsigned char iv[16];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_0_bytes_in_multiple_parts)
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_1_bytes_in_multiple_parts_1)
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_1_bytes_in_multiple_parts_2)
            size_t first_length = 0;
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_16_bytes_in_multiple_parts_1)
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_16_bytes_in_multiple_parts_2)
            size_t first_length = 0;
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_16_bytes_in_multiple_parts_3)
            size_t first_length = 1;
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_16_bytes_in_multiple_parts_4)
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_22_bytes_in_multiple_parts_1)
            size_t first_length = 15;
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_32_bytes_in_multiple_parts_1)
            size_t first_length = 16;
            size_t second_length = 16;
            size_t length = first_length + second_length;
            unsigned char key[32];
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_0_bytes)
            ...
            /* Check and get info structures */
            cipher_info = cipher_info_from_type( POLARSSL_CIPHER_BLOWFISH_CFB64 );
            fct_chk( NULL != cipher_info );
            fct_chk( cipher_info_from_string( "BLOWFISH-CFB64" ) == cipher_info );
        ...
        FCT_TEST_BGN(blowfish_encrypt_and_decrypt_0_bytes)
            ...
            /* Check and get info structures */
            cipher_info = cipher_info_from_type( POLARSSL_CIPHER_BLOWFISH_CTR );
            fct_chk( NULL != cipher_info );
            fct_chk( cipher_info_from_string( "BLOWFISH-CTR" ) == cipher_info );
